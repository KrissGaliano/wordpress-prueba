...
Please install and activate it before starting to use the theme Printo.
...
Theme documentation is available on https://printo.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Printo is Fontello.
