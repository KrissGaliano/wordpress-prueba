...
if ( ! function_exists( 'printo_woocommerce_get_css' ) ) {
	add_filter( 'printo_filter_get_css', 'printo_woocommerce_get_css', 10, 2 );
	function printo_woocommerce_get_css( $css, $args ) {
...
$fdir = printo_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
