...
if ( ! function_exists( 'printo_trx_addons_get_css' ) ) {
	add_filter( 'printo_filter_get_css', 'printo_trx_addons_get_css', 10, 2 );
	function printo_trx_addons_get_css( $css, $args ) {
