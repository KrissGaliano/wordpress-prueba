...
if ( ! function_exists( 'printo_tribe_events_get_css' ) ) {
	add_filter( 'printo_filter_get_css', 'printo_tribe_events_get_css', 10, 2 );
	function printo_tribe_events_get_css( $css, $args ) {
