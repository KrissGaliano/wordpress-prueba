   ...
   <div class="tp-header-area tp-header-space tp-header-bottom-border p-relative z-index-1">
      <div class="container-fluid">
         <div class="row align-items-center">
            ...
            <div class="<?php echo esc_attr($cetalog_menu_col); ?>">
               <div class="tp-main-menu-area d-flex align-items-center pl-20 <?php echo esc_attr($cetalog_menu_justify); ?>">
                  <?php if(!empty($cetalog_side_hide)) : ?>
                  <div class="tp-header-navbar tp-toogle d-none d-xxl-block">
                     <a href="javascript:void(0)"><i class="fa-regular fa-bars"></i></a>
                  </div>
                  <?php endif; ?>
            ...
            <div class="col-xl-4 col-lg-6 d-none d-lg-block">
               <div class="tp-header-right d-flex align-items-center justify-content-end">
                  ...
                  <div class="tp-header-login ml-20">
                  ...
                  <div class="tp-header-btn d-flex ml-20">
                     <a class="tp-btn-sm" href="<?php echo esc_url($cetalog_hbtn2_url); ?>"><?php echo cetalog_kses($cetalog_hbtn2_title); ?></a>
                  </div>
                  <?php endif; ?>
               </div>
            </div>
